...
if (!include LITHIUM_LIBRARY_PATH . '/lithium/core/Libraries.php') {
	...
	$message .= __FILE__ . ". LITHIUM_LIBRARY_PATH is ". LITHIUM_LIBRARY_PATH . " It should point to the directory containing your ";
	$message .= "Lithium_APP_PATH is : " . LITHIUM_APP_PATH . " why can't we find anything?\n\r";
